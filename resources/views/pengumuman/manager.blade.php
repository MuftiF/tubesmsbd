    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 pb-5 border-b border-gray-200">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Tambah, lihat, dan kelola pengumuman perusahaan</p>
                </div>
        ...
        <div class="bg-white rounded-2xl p-5 md:p-6 mb-6 border border-gray-200 shadow-sm">
            <div class="flex items-center gap-3 pb-4 mb-5 border-b border-[#eaf4f1]">
                ...
                <h2 class="text-sm font-semibold text-gray-700">Tambah Pengumuman Baru</h2>
            </div>

            <form method="POST" action="{{ route('manager.pengumuman.store') }}" class="space-y-4">
                @csrf
                <div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-2xl p-5 md:p-6 border border-gray-200 shadow-sm hover:border-[#eaf4f1] hover:shadow-md transition-all duration-200">
                <div class="flex flex-wrap justify-between items-start gap-3 mb-3">
                    ...
                    <form action="{{ route('manager.pengumuman.delete', $a->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
