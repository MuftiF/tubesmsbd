...
<div class="max-w-7xl mx-auto">
    ...
    <!-- Filter Section -->
    <form method="GET" action="{{ route('admin.laporan') }}" class="bg-white rounded-xl shadow-lg p-6 mb-6">
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('admin.laporan') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg font-semibold transition duration-200">
                Reset
            </a>
        </div>
    </form>
