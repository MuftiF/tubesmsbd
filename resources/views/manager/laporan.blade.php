...
<div class="bg-gray-50 min-h-screen p-6 md:p-8">
    <div class="max-w-7xl mx-auto">
        ...
        {{-- Filter Box --}}
        <form method="GET" action="{{ route('manager.laporan') }}" class="bg-white rounded-2xl p-5 md:p-6 mb-8 border border-gray-200 shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-100 rounded-full h-2 overflow-hidden">
                                <div class="bg-[#2c5e4e] h-full rounded-full transition-all" style="width: {{ ($daily->total_weight / $maxWeight) * 100 }}%"></div>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                @if($dailyAttendance->count())
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-100 rounded-full h-2 overflow-hidden">
                                <div class="bg-[#2c5e4e] h-full rounded-full transition-all" style="width: {{ $totalPegawai > 0 ? ($daily->total / $totalPegawai) * 100 : 0 }}%"></div>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <tbody>
                        @foreach($detailedAttendances as $a)
                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-[#eaf4f1] text-[#2c5e4e]">
                                        {{ $a->user?->role ?? 'unknown' }}
                                    </span>
                                </td>
                                ...
                                <td class="px-4 py-3">
                                    @if($a->checkout_photo_path)
                                        <a href="{{ asset('storage/'.$a->checkout_photo_path) }}" target="_blank"
                                            class="inline-flex items-center gap-1 bg-[#eaf4f1] px-3 py-1.5 rounded-full text-xs font-semibold text-[#2c5e4e] hover:bg-[#d5ecdf] transition">
                                            Lihat
                                        </a>
